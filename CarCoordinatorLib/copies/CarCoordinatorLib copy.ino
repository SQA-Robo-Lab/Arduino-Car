...
void loop(){
    ...
    Serial.println(ArduinoMessageBuffer_doesMessageExist(sub->messageBuffer));
    Serial.println(sub->messageBuffer->ringBuffer->numElements(sub->messageBuffer->ringBuffer));
    delay(1000);
